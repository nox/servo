...
pub struct HTMLMediaElement {
    ...
    /// https://html.spec.whatwg.org/multipage/media.html#dom-media-networkstate-2
    // FIXME(nox): Use an enum.
    network_state: Cell<u16>,
    /// https://html.spec.whatwg.org/multipage/media.html#dom-media-readystate-2
    // FIXME(nox): Use an enum.
    ready_state: Cell<u16>,
    /// https://html.spec.whatwg.org/multipage/media.html#dom-media-currentsrc-2
    current_src: DOMRefCell<String>,
    // FIXME(nox): Document this one, I have no idea what it is used for.
    generation_id: Cell<u32>,
    /// https://html.spec.whatwg.org/multipage/media.html#fire-loadeddata
    ///
    /// Reset to false every time the load algorithm is invoked.
    fired_loadeddata_event: Cell<bool>,
    /// https://html.spec.whatwg.org/multipage/media.html#dom-media-error-2
    error: MutNullableJS<MediaError>,
    /// https://html.spec.whatwg.org/multipage/media.html#dom-media-paused-2
    paused: Cell<bool>,
